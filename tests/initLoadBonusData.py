...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #Insert test data
        self.cur.execute("INSERT INTO CHARGES (CURRENCY_ID,SITE_ID,CHARGE_TYPE_ID,DOC_ID,CHARGE_ID,CUST_ID,CATEG_ID,ITEM_ID,QUANTITY,UNIT_PRICE,CHARGE_DT,CHARGE_STATUS,PAY_STATUS,INS_DT,REF_CHARGE_ID,BID_CUST_ID,PAY_AMOUNT,BID_SEQUENCE,CUST_SITE,ORIG_CURRENCY,DOL_UNIT_PRICE,ORIG_UNIT_PRICE,ORIG_ITEM_UNIT_PRICE,FROM_PRG,ORIG_ITEM_CURRENCY,FROM_USER,COMMENTS,BONIF_STATUS,COLLECTED_AMOUNT,MAIL_BONIF,PREPAY,AFF_SITE_CHARGE,AFF_PYMNT_CHARGE,TIMESTAMP,QTY_BONIF,AFF_CHARGE_PRICE,SEARCH_WORD,COMBO_TYPE_ID) VALUES ('REA','IBZ','BV',347692,4284859,10837411,NULL,6759204,1,-0.97,TO_DATE('13-AUG-2012 22:47:39','DD-MON-RRRR HH24:MI:SS'),'F','I',TO_DATE('04-SEP-2012 13:13:21','DD-MON-RRRR HH24:MI:SS'),4112436,10205213,NULL,1,'MLB','REA',-1.92,-6,NULL,'MED',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,TO_DATE('23-MAY-2012 12:14:27','DD-MON-RRRR HH24:MI:SS'),NULL,NULL,NULL,NULL)");
        self.db.commit()

        #Corro script
        f = open('resources/CARGA_INICIAL_BONUSES.SQL')
        full_sql = f.read()
    ...
    def test2_delete_loaded_data(self):
        #Delete test 
        try:
